  ...
  return (
    <input
      ...
      className={cn(
        ...
        "aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive !bg-foreground border !border-primary/30 text-secondary placeholder:text-sm",
        className
      )}
      {...props}
    />
